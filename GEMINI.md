...
- **Correções Recentes:**
    ...
    - Criado o fluxo de importação manual `workflow-import-historical-contacts.json` para importar de forma retroativa os contatos antigos de qualquer instância da Evolution API para o Trello, aplicando a nova deduplicação real do Trello.
